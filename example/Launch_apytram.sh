...
$APYTRAM -d $WORKING_DIR/db/souris:MM,$WORKING_DIR/db/hamster:HM -dt paired:MM,paired:HM -out $OUTPUT_DIR/apytram -fq $DATA_DIR/rna_seq/fastq/Mesocricetus_auratus.datatest.fq:HM,$DATA_DIR/rna_seq/fastq/Mus_musculus.datatest.fq:MM -q $DATA_DIR/query/reference.nogap.fa:HH_Mus --out_by_species  -log apytram.log -tmp $WORKING_DIR/apytram_tmp --keep_tmp --cds
